            ...
            <form id="contact-form" name="contact-form" action="contactform.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <div class="md-form mb-0">
                            <input type="number" id="name" name="mobile" class="form-control">
                            <label for="name" required class="">Mobile No</label>
                        </div>
                    </div>
                    <!--Grid column-->
